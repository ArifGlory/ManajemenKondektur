...
@section('breadcrumb')
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-chess-queen'></i> Wali Santri
            <small>
                Data Wali Santri
            </small>
        </h1>
        <div class="btn-group btn-group-sm text-center float-right" jabatan="group">
                <a href="{{ route('wali-santri.create') }}" class="btn btn-primary btn-mini waves-effect waves-light"><span class="fal fa-plus"></span> Tambah Wali Santri</a>
                <a href="{{ route('wali-santri.create-multi') }}" class="btn btn-success btn-mini waves-effect waves-light"><span class="fal fa-plus"></span> Tambah Wali Santri Massal</a>
        </div>
    </div>
@endsection
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        <strong id="title-table">Wali Santri</strong> <span class="fw-300"><i>Table</i></span>
                    </h2>
