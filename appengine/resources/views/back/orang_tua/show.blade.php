...
@section('breadcrumb')
    <ol class="breadcrumb dokumen-breadcrumb">
        ...
        <li class="breadcrumb-item active">Detail Wali Santri</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-newspaper'></i> Detail Wali Santri
            <small>
                Detail Wali Santri ini.
            </small>
        </h1>
        <div class="btn-group btn-group-sm text-center float-right" role="group">
            ...
            <a href="#" class="btn btn-success btn-mini waves-effect waves-light"><span class="fal fa-lock"></span> Reset Password</a>
        </div>
    </div>
@endsection
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel">
                <div class="panel-hdr">
                    <h2>
                        <strong id="title-table">Detail</strong> <span class="fw-300"><i>Wali Santri</i></span>
                    </h2>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-hdr">
                    <h2>
                        <strong id="title-table">Santri milik Wali Santri ini</strong> <span class="fw-300"><i></i></span>
                    </h2>
                    <div class="pull-right">
                        @if(Auth::user()->jenis_user != "admin")
                           {{-- <a href="{{ route('Wali Santri.add-santri',$data->id) }}" class="btn btn-success btn-sm waves-effect text-sm-center"><i
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        @php
                            $no = 1;
                        @endphp
                        <table class="table table-bordered table-hover table-striped w-100" id="wali-table">
                            <thead>
                            <tr>
                                <td width="2%">No</td>
                                <td>Nama Santri</td>
