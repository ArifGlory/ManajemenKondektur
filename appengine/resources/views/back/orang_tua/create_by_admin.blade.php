...
@section('breadcrumb')
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-file'></i> Tambah wali-santri
            <small>
...
@section('content')
    {!! Form::open(['route' => 'wali-santri.store', 'method' => 'POST', 'id' => 'form-wali-santri', 'files' => true]) !!}
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-12 col-md-4 col-form-label">Pesantren</label>
                            <div class="col-sm-12 col-md-8">
                                <select name="id_pesantren" class="form-control select2">
                                    @foreach($pesantren as $val)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-8">
                                <h4>Password akan dibuat default menjadi :  12345678</h4>
                                <h5>Password dapat diubah oleh wali santri</h5>
                            </div>
                        </div>
                    </div>
                </div>
