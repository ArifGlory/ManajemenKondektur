...
@section('content')
    {!! Form::model($data,['route' => ['jadwal.update', $data->id_jadwal], 'method' => 'PUT', 'id' => 'form-Jadwal', 'files' => true]) !!}
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-8">
                                <input class="form-control" type="date" name="tanggal_jadwal" value="{{$data->tanggal_jadwal}}">
