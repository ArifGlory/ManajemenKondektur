                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <h5>{{$data->nama_jadwal}}</h5>
                                </div>
                                <div class="form-group mt-4">
                                    <label class="form-label">Keterangan Jadwal</label>
                                    <h5>{{$data->keterangan_jadwal}}</h5>
                                </div>
                                <div class="form-group mt-3">
                                    <label class="form-label">Dilaksanakan pada</label>
