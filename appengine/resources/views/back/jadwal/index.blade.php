@extends('layouts.app')
@section('title', 'Jadwal Kegiatan Aktivitas')
...
@section('breadcrumb')
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-chess-queen'></i> Jadwal Kegiatan
            <small>
                Data Jadwal Kegiatan yang akan berlangsung
            </small>
        </h1>
        <div class="btn-group btn-group-sm text-center float-right" jabatan="group">
            @if(Auth::user()->jenis_user != "admin")
                <a href="{{ route('jadwal.create') }}" class="btn btn-primary btn-mini waves-effect waves-light"><span class="fal fa-plus"></span> Tambah Jadwal</a>
            @endif
        </div>
    </div>
@endsection
    ...
    <div class="row">
        <div class="col-sm-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        <strong id="title-table">Jadwal Aktivitas</strong> <span class="fw-300"><i>Table</i></span>
                    </h2>
    ...
    $(function(){
        ...
        table = $('#cuti-table').DataTable({
            ...
            columns: [
                ...
                {
                    data: 'nama_jadwal', name: 'nama_jadwal', orderable: true,
                },
                {
