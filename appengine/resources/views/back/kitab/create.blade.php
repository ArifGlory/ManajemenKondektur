...
@section('breadcrumb')
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">Tambah Kitab</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-file-pdf'></i> Tambah Kitab
            <small>
...
@section('content')
    {!! Form::open(['route' => 'kitab.store', 'method' => 'POST', 'id' => 'form-kitab', 'files' => true]) !!}
        <div class="row">
                    ...
                    <div class="card-header bg-dark text-white">
                        <div class="row">
                            <div class="col">
                                ...
                                <span>Silahkan mengisi data Kitab</span>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
