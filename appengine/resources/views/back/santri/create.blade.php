...
@section('content')
    {!! Form::open(['route' => 'santri.store', 'method' => 'POST', 'id' => 'form-Santri', 'files' => true]) !!}
        <div class="row">
            <div class="col-sm-12 col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-12 col-md-4 col-form-label">Foto Santri</label>
                            <div class="col-sm-12 col-md-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-8">
                                <select name="email_wali_santri" class="form-control select2">
                                        <option value="null"> Belum ada data Wali Santri </option>
