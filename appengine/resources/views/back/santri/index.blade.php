...
@section('breadcrumb')
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-chess-queen'></i> Santri
            <small>
                Berisi Data Santri, kitab santri ,  dan Pelanggaran santri
            </small>
        </h1>
        <div class="btn-group btn-group-sm text-center float-right" jabatan="group">
            @if(Auth::user()->jenis_user != "admin")
                <a href="{{ route('santri.create') }}" class="btn btn-primary btn-mini waves-effect waves-light"><span class="fal fa-plus"></span> Tambah Santri</a>
                <a href="{{ route('santri.create-multi') }}" class="btn btn-success btn-mini waves-effect waves-light"><span class="fal fa-plus"></span> Input Santri Massal</a>
            @endif
        </div>
    </div>
@endsection
    ...
    <div class="row">
        <div class="col-sm-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        <strong id="title-table">Santri</strong> <span class="fw-300"><i>Table</i></span>
                    </h2>
