@extends('layouts.app')
@section('title', 'Ubah Tagihan Pembayaran')
...
@section('breadcrumb')
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">Ubah Tagihan Pembayaran</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-file'></i> Ubah Tagihan Pembayaran
            <small>
                Silahkan pilih santri untuk diUbahlan tagihan nya
            </small>
        </h1>
...
@section('content')
    {!! Form::model($data,['route' => ['pembayaran.update', $data->id_pembayaran], 'method' => 'PUT', 'id' => 'form-pembayaran', 'files' => true]) !!}
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <select class="form-control select2" name="id_santri" id="selectSantri" required>
                                    <option value="{{$data->id_santri}}"> Terpilih -  {{$data->nama_santri}} </option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <select class="form-control select2" name="bulan" id="bulan" required>
                                    <option value="{{$data->bulan}}">Terpilih - {{$data->bulan}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <select class="form-control" name="tahun" id="tahun" required>
                                    <option value="{{$data->tahun}}"> Terpilih - {{$data->tahun}} </option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="number" value="{{$data->jml_bayar}}" name="jml_bayar" onkeypress="return isNumber(event)" class="form-control">
                                @error('jml_bayar')
                                <div class="col-form-label">
                                    <strong>{{ $message }}</strong>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <select class="form-control" name="status_pembayaran" id="status_pembayaran" required>
                                    <option value="{{$data->status_pembayaran}}"> Terpilih -  {{$data->status_pembayaran}}</option>
