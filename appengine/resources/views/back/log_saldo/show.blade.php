...
@section('breadcrumb')
    <ol class="breadcrumb dokumen-breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('log-saldo.index') }}">Log Saldo</a></li>
        <li class="breadcrumb-item active">Detail Log Saldo</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-newspaper'></i> Log Saldo
            <small>
                Log Saldo.
            </small>
        </h1>
        <div class="btn-group btn-group-sm text-center float-right" role="group">
            <a href="{{ route('log-saldo.index') }}" class="btn btn-primary btn-mini waves-effect waves-light"><span class="fal fa-backward"></span> Kembali</a>
        </div>
    </div>
@endsection
    ...
    <div class="row">
        <div class="col-sm-12 col-md-8">
            <div class="panel">
                <div class="panel-hdr">
                    <h2>
                        <strong id="title-table">Detail</strong> <span class="fw-300"><i>Log saldo</i></span>
                    </h2>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <h5>Rp. {{ number_format($data->jumlah,0,',','.')}}</h5>
                                </div>
                                <div class="form-group mt-4">
