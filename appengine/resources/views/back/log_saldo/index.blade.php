...
@section('breadcrumb')
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">Log Saldo</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-chess-queen'></i> Log Saldo
            <small>
                Data Log Saldo
            </small>
        </h1>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        <strong id="title-table">Log Saldo</strong> <span class="fw-300"><i>Table</i></span>
                    </h2>
    ...
    $(function(){
        ...
        table = $('#cuti-table').DataTable({
            ...
            columns: [
                ...
                {
                    data: 'tanggal_log', name: 'tanggal_log', orderable: true,
                },
                {
