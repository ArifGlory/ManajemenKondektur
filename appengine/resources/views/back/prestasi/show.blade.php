...
@section('breadcrumb')
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-newspaper'></i> Detail Prestasi
            <small>
                Detail Prestasi ini.
            </small>
        </h1>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel">
                <div class="panel-hdr">
                    <h2>
                        <strong id="title-table">Detail</strong> <span class="fw-300"><i>Prestasi</i></span>
                    </h2>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mt-3">
                                    ...
                                    <h2>{{$data->nama_prestasi}}</h2>
                                </div>
                                <div class="form-group mt-3">
                                    <label class="form-label">Nama Santri</label>
                                    <h3>{{$data->nama_santri}}</h3>
                                </div>
                                <div class="form-group mt-3">
