...
@section('breadcrumb')
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-file'></i> Edit Prestasi
            <small>
                Silahkan ubah data Prestasi
            </small>
        </h1>
...
@section('content')
    {!! Form::model($data,['route' => ['prestasi.update', $data->id_prestasi], 'method' => 'PUT', 'id' => 'form-prestasi', 'files' => true]) !!}
        <div class="row">
