...
@section('breadcrumb')
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-chess-queen'></i> Dokumen Pegawai
            <small>
                Data Dokumen Pegawai
            </small>
        </h1>
        <div class="btn-group btn-group-sm text-center float-right" jabatan="group">
            <a href="{{ route('kelas.create') }}" class="btn btn-primary btn-mini waves-effect waves-light"><span class="fal fa-plus"></span> Buat Dokumen Pegawai</a>
        </div>
    </div>
@endsection
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        <strong id="title-table">Dokumen Pegawai</strong> <span class="fw-300"><i>Table</i></span>
                    </h2>
    ...
    $(function(){
        ...
        table = $('#cuti-table').DataTable({
            ...
            columns: [
                ...
                {
                    data: 'no_sk', name: 'no_sk', orderable: true,
                },
                {
                    data: 'nama_jenis_sk', name: 'nama_jenis_sk', orderable: true,
                },
                {
                    data: 'nama_dokumen', name: 'nama_dokumen', orderable: true,
                },
                {
