...
@section('breadcrumb')
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-file'></i> Tambah Kelas
            <small>
...
@section('content')
    {!! Form::open(['route' => 'kelas.store', 'method' => 'POST', 'id' => 'form-kelas', 'files' => true]) !!}
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-8">
                                {!! Form::text('nama_kelas', null, ['class' => 'form-control', $errors->has('nama_kelas') ? 'form-control-danger' : '', 'placeholder' => 'Nama kelas']) !!}
                                @error('kelas')
