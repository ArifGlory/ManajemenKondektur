...
@section('breadcrumb')
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-newspaper'></i> Detail kelas
            <small>
                Detail kelas ini.
            </small>
        </h1>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel">
                <div class="panel-hdr">
                    <h2>
                        <strong id="title-table">Detail</strong> <span class="fw-300"><i>kelas</i></span>
                    </h2>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-hdr">
                    <h2>
                        <strong id="title-table">Santri di Kelas ini</strong> <span class="fw-300"><i></i></span>
                    </h2>
                    <div class="pull-right">
                        @if(Auth::user()->jenis_user != "admin")
                            <a href="{{ route('kelas.add-santri',$data->id_kelas) }}" class="btn btn-success btn-sm waves-effect text-sm-center"><i
                            ...
                            @foreach($santri_dikelas as $val)
                                <tr>
                                    ...
                                    <td class="text-center align-items-center">
                                        ...
                                        <a href="{{ route('kelas.remove-santri',$val->id_isi_kelas) }}" class="button btn-sm btn-danger text-white"> Hapus dari kelas</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
