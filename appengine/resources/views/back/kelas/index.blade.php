...
@section('breadcrumb')
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-chess-queen'></i> Kelas
            <small>
                Data Kelas
            </small>
        </h1>
        <div class="btn-group btn-group-sm text-center float-right" jabatan="group">
            @if(Auth::user()->jenis_user != "admin")
                <a href="{{ route('kelas.create') }}" class="btn btn-primary btn-mini waves-effect waves-light"><span class="fal fa-plus"></span> Tambah Kelas</a>
            @endif
        </div>
    </div>
@endsection
    ...
    <div class="row">
        <div class="col-sm-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        <strong id="title-table">Kelas</strong> <span class="fw-300"><i>Table</i></span>
                    </h2>
