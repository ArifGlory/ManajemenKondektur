...
Route::post('/update-profile', 'HomeController@updateProfile')->middleware('auth')->name('update-profile');
...
Route::group([
    ...
    Route::post('update-tukar-jadwal', [\App\Http\Controllers\Back\JadwalController::class, 'updateTukarJadwal'])->name('jadwal.update-tukar-jadwal');
