...
! function(a) {
    ...
    b = wpNavMenu = {
        ...
        jQueryExtensions: function() {
            a.fn.extend({
                ...
                updateDepthClass: function(b, c) {
                    return this.each(function() {
                        var d = a(this);
                        c = c || d.menuItemDepth(), a(this).removeClass("wmenu-item-depth-" + c).addClass("wmenu-item-depth-" + b)
                    })
                },
                shiftDepthClass: function(b) {
                    return this.each(function() {
                        var c = a(this),
                            d = c.menuItemDepth();
                        a(this).removeClass("wmenu-item-depth-" + d).addClass("wmenu-item-depth-" + (d + b))
                    })
                },
                ...
                updateParentMenuItemDBId: function() {
                    ...
                    return this.each(function() {
                        var b = a(this),
                            c = b.find(".wmenu-item-data-parent-id"),
                            d = parseInt(b.menuItemDepth(), 10),
                            e = d - 1,
                            f = b.prevAll(".wmenu-item-depth-" + e).first();
                        c.val(0 === d ? 0 : f.find(".wmenu-item-data-db-id").val())
                    })
                },
                ...
                addSelectedToMenu: function(c) {
                    return 0 === a("#menu-to-edit").length ? !1 : this.each(function() {
                        ...
                        return c = c || b.addMenuItemToBottom, f.length ? (d.find(".spinner").show(), a(f).each(function() {
                            ...
                            this.className && -1 != this.className.indexOf("add-to-top") && (c = b.addMenuItemToTop), e[h] = d.closest("li").getItemData("add-wmenu-item", h)
                ...
                getItemData: function(a, b) {
                    a = a || "wmenu-item";
                    var c, d = {},
                        e = ["wmenu-item-db-id", "wmenu-item-object-id", "wmenu-item-object", "wmenu-item-parent-id", "wmenu-item-position", "wmenu-item-type", "wmenu-item-title", "wmenu-item-url", "wmenu-item-description", "wmenu-item-attr-title", "wmenu-item-target", "wmenu-item-classes", "wmenu-item-xfn"];
                    return b || "wmenu-item" != a || (b = this.find(".wmenu-item-data-db-id").val()), b ? (this.find("input").each(function() {
                        var f;
                        for (c = e.length; c--;) "wmenu-item" == a ? f = e[c] + "[" + b + "]" : "add-wmenu-item" == a && (f = "wmenu-item[" + b + "][" + e[c] + "]"), this.name && f == this.name && (d[e[c]] = this.value)
                    }), d) : d
                },
                setItemData: function(b, c, d) {
                    return c = c || "wmenu-item", d || "wmenu-item" != c || (d = a(".wmenu-item-data-db-id", this).val()), d ? (this.find("input").each(function() {
                        var e, f = a(this);
                        a.each(b, function(a, b) {
                            "wmenu-item" == c ? e = a + "[" + d + "]" : "add-wmenu-item" == c && (e = "wmenu-item[" + d + "][" + a + "]"), e == f.attr("name") && f.val(b)
                        })
                    }), this) : this
                }
            })
        ...
        countMenuItems: function(b) {
            return a(".wmenu-item-depth-" + b).length
        },
        moveMenuItem: function(c, d) {
            var e, f, g, h = a("#menu-to-edit li"),
                i = h.length,
                j = c.parents("li.wmenu-item"),
                k = j.childMenuItems(),
                l = j.getItemData(),
                ...
                t = r.getItemData()["wmenu-item-db-id"];
            switch (d) {
                case "up":
                    if (f = n - 1, 0 === n) break;
                ...
                case "right":
                    if (0 === n) break;
                    if (l["wmenu-item-parent-id"] === t) break;
                    j.shiftHorizontally(1)
            }
        ...
        initAccessibility: function() {
            ...
            b.refreshKeyboardAccessibility(), b.refreshAdvancedAccessibility(), c.on("click", ".menus-move-up", function(c) {
                b.moveMenuItem(a(this).parents("li.wmenu-item").find("a.item-edit"), "up"), c.preventDefault()
            }), c.on("click", ".menus-move-down", function(c) {
                b.moveMenuItem(a(this).parents("li.wmenu-item").find("a.item-edit"), "down"), c.preventDefault()
            }), c.on("click", ".menus-move-top", function(c) {
                b.moveMenuItem(a(this).parents("li.wmenu-item").find("a.item-edit"), "top"), c.preventDefault()
            }), c.on("click", ".menus-move-left", function(c) {
                b.moveMenuItem(a(this).parents("li.wmenu-item").find("a.item-edit"), "left"), c.preventDefault()
            }), c.on("click", ".menus-move-right", function(c) {
                b.moveMenuItem(a(this).parents("li.wmenu-item").find("a.item-edit"), "right"), c.preventDefault()
            })
        },
        refreshAdvancedAccessibility: function() {
            a(".wmenu-item-settings .field-move a").css("display", "none"), a(".item-edit").each(function() {
                var b, c, d, e, f, g, h, i, j, k = a(this),
                    l = k.closest("li.wmenu-item").first(),
                    m = l.menuItemDepth(),
                    n = 0 === m,
                    o = k.closest(".wmenu-item-handle").find(".wmenu-item-title").text(),
                    p = parseInt(l.index(), 10),
                    q = n ? m : parseInt(m - 1, 10),
                    r = l.prevAll(".wmenu-item-depth-" + q).first().find(".wmenu-item-title").text(),
                    s = l.prevAll(".wmenu-item-depth-" + m).first().find(".wmenu-item-title").text(),
                    t = a("#menu-to-edit li").length,
                    u = l.nextAll(".wmenu-item-depth-" + m).length;
                0 !== p && (b = l.find(".menus-move-up"), b.prop("title", menus.moveUp).css("display", "inline")), 0 !== p && n && (b = l.find(".menus-move-top"), b.prop("title", menus.moveToTop).css("display", "inline")), p + 1 !== t && 0 !== p && (b = l.find(".menus-move-down"), b.prop("title", menus.moveDown).css("display", "inline")), 0 === p && 0 !== u && (b = l.find(".menus-move-down"), b.prop("title", menus.moveDown).css("display", "inline")), n || (b = l.find(".menus-move-left"), c = menus.outFrom.replace("%s", r), b.prop("title", menus.moveOutFrom.replace("%s", r)).html(c).css("display", "inline")), 0 !== p && l.find(".wmenu-item-data-parent-id").val() !== l.prev().find(".wmenu-item-data-db-id").val() && (b = l.find(".menus-move-right"), c = menus.under.replace("%s", s), b.prop("title", menus.moveUnder.replace("%s", s)).html(c).css("display", "inline")), n ? (d = a(".wmenu-item-depth-0"), e = d.index(l) + 1, t = d.length, f = menus.menuFocus.replace("%1$s", o).replace("%2$d", e).replace("%3$d", t)) : (g = l.prevAll(".wmenu-item-depth-" + parseInt(m - 1, 10)).first(), h = g.find(".wmenu-item-data-db-id").val(), i = g.find(".wmenu-item-title").text(), j = a('.wmenu-item .wmenu-item-data-parent-id[value="' + h + '"]'), e = a(j.parents(".wmenu-item").get().reverse()).index(l) + 1, f = menus.subMenuFocus.replace("%1$s", o).replace("%2$d", e).replace("%3$s", i)), k.prop("title", f).html(f)
            })
        },
            ...
            a(".item-edit").off("focus").on("focus", function() {
                a(this).off("keydown").on("keydown", function(c) {
                    ...
                    if ((37 == c.which || 38 == c.which || 39 == c.which || 40 == c.which) && (e.off("keydown"), 1 !== a("#menu-to-edit li").length)) {
                        ...
                        return a("#edit-" + g["wmenu-item-db-id"]).focus(), !1
                    }
                })
            })
        },
        initPreviewing: function() {
            a("#menu-to-edit").on("change input", ".edit-wmenu-item-title", function(b) {
                var c, d, e = a(b.currentTarget);
                c = e.val(), d = e.closest(".wmenu-item").find(".wmenu-item-title"), c ? d.text(c).removeClass("no-title") : d.text(navMenuL10n.untitled).addClass("no-title")
            })
        },
        ...
        initSortables: function() {
            ...
            function f(c) {
                ...
                if (0 !== c) {
                    if (c > 0) d = p + c, d > t && (e = d);
                        ...
                        for (; !a(".wmenu-item-depth-" + e, b.menuList).length && e > 0;) e--;
            ...
            0 !== a("#menu-to-edit li").length && a(".drag-instructions").show(), r += b.isRTL ? b.menuList.width() : 0, b.menuList.sortable({
                handle: ".wmenu-item-handle",
                placeholder: "sortable-placeholder",
                start: function(e, f) {
                    var h, i, j, k, l;
                    b.isRTL && (f.item[0].style.right = "auto"), o = f.item.children(".wmenu-item-transport"), g = f.item.menuItemDepth(), d(f, g), j = f.item.next()[0] == f.placeholder[0] ? f.item.next() : f.item, k = j.childMenuItems(), o.append(k), h = o.outerHeight(), h += h > 0 ? 1 * f.placeholder.css("margin-top").slice(0, -2) : 0, h += f.helper.outerHeight(), n = h, h -= 2, f.placeholder.height(h), p = g, k.each(function() {
                        var b = a(this).menuItemDepth();
                        p = b > p ? b : p
                    }), i = f.helper.find(".wmenu-item-handle").outerWidth(), i += b.depthToPx(p - g), i -= 2, f.placeholder.width(i), l = f.placeholder.next(), l.css("margin-top", n + "px"), f.placeholder.detach(), a(this).sortable("refresh"), f.item.after(f.placeholder), l.css("margin-top", 0), c(f)
                },
                stop: function(a, c) {
                    var d, e, h = q - g;
        ...
        attachTabsPanelListeners: function() {
            a("#menu-settings-column").bind("click", function(c) {
                ...
                if (h.hasClass("nav-tab-link")) e = h.data("type"), f = h.parents(".accordion-section-content").first(), a("input", f).removeAttr("checked"), a(".tabs-panel-active", f).removeClass("tabs-panel-active").addClass("tabs-panel-inactive"), a("#" + e, f).removeClass("tabs-panel-inactive").addClass("tabs-panel-active"), a(".tabs", f).removeClass("tabs"), h.parent().addClass("tabs"), a(".quick-search", f).focus(), c.preventDefault();
                    ...
                    if (d = /#(.*)$/.exec(c.target.href), d && d[1]) return g = a("#" + d[1] + " .tabs-panel-active .wmenu-item-title input"), g.length === g.filter(":checked").length ? g.removeAttr("checked") : g.prop("checked", !0), !1
                } else {
        ...
        eventOnClickEditLink: function(b) {
            ...
            return e && e[1] && (c = a("#" + e[1]), d = c.parent(), 0 !== d.length) ? (d.hasClass("wmenu-item-edit-inactive") ? (c.data("wmenu-item-data") || c.data("wmenu-item-data", c.getItemData()), c.slideDown("fast"), d.removeClass("wmenu-item-edit-inactive").addClass("wmenu-item-edit-active")) : (c.slideUp("fast"), d.removeClass("wmenu-item-edit-active").addClass("wmenu-item-edit-inactive")), !1) : void 0
        },
        eventOnClickCancelLink: function(b) {
            var c = a(b).closest(".wmenu-item-settings"),
                d = a(b).closest(".wmenu-item");
            return d.removeClass("wmenu-item-edit-active").addClass("wmenu-item-edit-inactive"), c.setItemData(c.data("wmenu-item-data")).hide(), !1
        },
...
if (r == true) {
   var d = parseInt(c.id.replace("delete-", ""), 10);
            ...
            return b.removeMenuItem(a("#wmenu-item-" + d)), b.registerChange(), !1
        ...
        processQuickSearchQueryResponse: function(b, c, d) {
            ...
            return k.length ? (k.each(function() {
                if (g = a(this), e = j.exec(g.html()), e && e[1]) {
                    for (f = e[1]; i.elements["wmenu-item[" + f + "][wmenu-item-type]"] || h[f];) f--;
                    h[f] = !0, f != e[1] && g.html(g.html().replace(new RegExp("wmenu-item\\[" + e[1] + "\\]", "g"), "wmenu-item[" + f + "]"))
                }
